...
public class CreateTestData {
	public static void main(String argv[]) {
		...
		ArrayList<String> privacyWCtextOptions = new ArrayList<String>();
		...
		ArrayList<String> suddenInjuryOptions = new ArrayList<String>();
		...
		suddenInjuryOptions.add("suddenOther");
	      ...
	      try {
	   	  ...
	   	  for(int i=0; i<privacyWCtextOptions.size(); i++) {
	         ...
	         privacyWC.appendChild(doc.createTextNode(privacyWCtextOptions.get(i)));
	         introductionGroup.appendChild(privacyWC);
	         rootElement.appendChild(introductionGroup);

	         //if privacyWCtextOption == yes
	         if(privacyWCtextOptions.get(i).equals(privacyWCtextOptions.get(0))) {
	         ...
	         StreamResult result = new StreamResult(new File("/Users/prajwal/DISK B/Eclipse Workspace/FormsTask/ParseFormData/src/demofile.xml"));
